...
!(function (e) {
    ...
    function h(e) {
        var n,
            ...
            l = i(e);
        a(l) ||
            (j.useBR ? ((n = document.createElementNS("http://www.w3.org/1999/xhtml", "div")), (n.innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n"))) : (n = e),
            (s = n.textContent),
            (r = l ? f(l, s, !0) : g(s)),
            (t = c(n)),
            t.length && ((o = document.createElementNS("http://www.w3.org/1999/xhtml", "div")), (o.innerHTML = r.value), (r.value = u(t, c(o), s))),
            (r.value = p(r.value)),
            (e.innerHTML = r.value),
    ...
    return {
        ...
        c: [
            ...
            { cN: "meta", b: /<\?xml/, e: /\?>/, r: 10 },
            {
                ...
                e: /\?>/,
                sL: "php",
                c: [{ b: "/\\*", e: "\\*/", skip: !0 }, { b: 'b"', e: '"', skip: !0 }, { b: "b'", e: "'", skip: !0 }, s.inherit(s.ASM, { i: null, cN: null, c: null, skip: !0 }), s.inherit(s.QSM, { i: null, cN: null, c: null, skip: !0 })],
            },
