        ...
        <div>
          ...
          <div className="damageRelations">
            {data?.data.damage_relations.double_damage_from.length > 0 && (
              <DoubleDamageFrom
                data={data?.data.damage_relations.double_damage_from}
                id={0}
                name={""}
              />
            )}
            {data?.data.damage_relations.half_damage_from.length > 0 && (
              <HalfDamageFrom
                data={data?.data.damage_relations.half_damage_from}
                id={0}
                name={""}
              />
            )}
            {data?.data.damage_relations.no_damage_from.length > 0 && (
              <NoDamageFrom
                data={data?.data.damage_relations.no_damage_from}
                id={0}
                name={""}
              />
            )}
            ...
            {data?.data.damage_relations.no_damage_to.length > 0 && (
              <NoDamageTo
                data={data?.data.damage_relations.no_damage_to}
                id={0}
                name={""}
              />
            )}
            {data?.data.damage_relations.half_damage_to.length > 0 && (
              <HalfDamageTo
                data={data?.data.damage_relations.half_damage_to}
                id={0}
                name={""}
              />
            )}
            {data?.data.damage_relations.double_damage_to.length > 0 && (
              <DoubleDamageTo
                data={data?.data.damage_relations.double_damage_to}
                id={0}
                name={""}
              />
            )}
      ...
      <section id="moves">
        ...
        {data?.data.moves.map((move: any, index: number) => {
          return (
            <button
              type="button"
              className="nes-btn nesBtn iserror btnPokemon"
              key={index}
            >
