...
const Carousel = () => {
  ...
  const {
    data: secondPokemonData,
    isLoading: secondPokemonLoading,
  ...
  const {
    data: thirdPokemonData,
    isLoading: thirdPokemonLoading,
  ...
  const {
    data: fourthPokemonData,
    isLoading: fourthPokemonLoading,
  ...
  const {
    data: fifthPokemonData,
    isLoading: fifthPokemonLoading,
  ...
  const {
    data: sixthPokemonData,
    isLoading: sixthPokemonLoading,
  ...
  const {
    data: seventhPokemonData,
    isLoading: seventhPokemonLoading,
  ...
  const {
    data: eighthPokemonData,
    isLoading: eighthPokemonLoading,
