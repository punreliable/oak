...
const EvolutionsHandler = (props: {id: number}) => {
	...
	{data && console.log('Evolution Chain: ', data?.evolution_chain?.url ? data?.evolution_chain.url: 'Not on an Evolution Chain.') }
	{data && console.log('Evolves From Species: ', data?.evolves_from_species?.url ? data?.evolves_from_species.url: 'This is a basic Pokemon.') }
	...
	return (
		<div className="nes-container">
			{data && ( showEvolutionChain || showEvolvesFromSpecies ) && (<div className='row'><h3 className='h3-responsive'>Evolutions</h3></div>)}
