    ...
    <div className='App'>
      ...
      <div className='row rowStats'>
        <div className='col-md-12 col-lg-12 stats'>
          {props.move.flavor_text_entries && <h2 className='my-4'>{props.move.flavor_text_entries[0].flavor_text}</h2>}
          {props.move.effect_entries && <h3 className="my-4">{props.move.effect_entries[0].effect}</h3>}
          ...
          <p>Generation: {
            dashRemover(prettyName(props.move.generation.name))
            }
          </p>
          )}
        </div>
