...
!(function () {
        ...
        (a.prototype = {
            ...
            showModal: function () {
                ...
                (function (e) {
                    ...
                    this.setOpen(!0),
                    (this.openAsModal_ = !0),
                    r.needsCentering(this.dialog_) ? (r.reposition(this.dialog_), (this.replacedStyleTop_ = !0)) : (this.replacedStyleTop_ = !1),
    ...
    if (
        ...
        (r.forceRegisterDialog = function (e) {
            if (((window.HTMLDialogElement || e.showModal) && console.warn("This browser already supports <dialog>, the polyfill may not work correctly", e), "dialog" !== e.localName))
